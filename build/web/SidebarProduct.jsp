        ...
        <form action="ProductLists"  method="get" style="
                ...
                <form action="ProductLists" method="post" class="my-form">
                    <div class="custom-radio-box" style="
                         ...
                         padding: 10px;">
                        <h2>Category</h2>
                        <label><input type="radio" name="cid" value="4" ${param.cid == 4 ? 'checked' : ''} onchange="this.form.submit()"> Coffee</label><br>
                        <label><input type="radio" name="cid" value="5" ${param.cid == 5 ? 'checked' : ''} onchange="this.form.submit()"> Tea</label>
                    </div>
