                                ...
                                <div class="col-md-6">
                                    <div class="form-group d-flex">
                                        <div class="select-wrap">
                                            ...
                                            <label>
                                                <span><input type="radio" name="psize" value="S" required>S: <p style="color: #f8b500; display: inline-block"> +0đ</span></p>
                                            </label><br>
                                            <label>
                                                <span><input type="radio" name="psize" value="M" required>M: <p style="color: #f8b500; display: inline-block"> +10.000đ</span></p>
                                            </label><br>
                                            <label>
                                                <span><input type="radio" name="psize" value="L" required>L: <p style="color: #f8b500; display: inline-block"> +20.000đ</span></p>
                                            </label><br>
...
//                }
                function updatePrice() {
                    ...
                    var selectedSize = $('input[name="psize"]:checked').val(); // Get the value of the selected size
                    switch (selectedSize) {
                        case 'S':
                            selectedSizePrice = 0; // Giá cho size S
                            break;
                        case 'M':
                            selectedSizePrice = 10; // Giá cho size M
                            break;
                        case 'L':
                            selectedSizePrice = 20; // Giá cho size L
                            break;
                        default:
                            selectedSizePrice = 0; // Giả sử mặc định là size S
                            break;
                    }
                    var totalPrice = (basePrice + selectedSizePrice) * quantity; // Tính tổng giá
                    $('#product-price').text(formatPrice(totalPrice)); // Cập nhật giá hiển thị
                }
