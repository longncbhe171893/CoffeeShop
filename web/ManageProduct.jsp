                        ...
                        <tbody>
                            <c:forEach var="p" items="${productlist}">
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('Do you want to change product status?')" href="UpdateStatusProduct?pid=${p.getId()}&psid=${p.getProduct_status()}">
                                            ${p.getProduct_status()==1?"Active":"Inactive"}</a></td>   
