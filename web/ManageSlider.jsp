                    ...
                    <c:forEach var="p" items="${listP}">
                        <tr>
                            ...
                            <td>
                                <form action="ManageSlider" method="post">
                                    <c:choose>
                                        <c:when test="${p.getProduct_status() eq 1}">
                                            <label><input type="radio" id="status_enable" name="status" value="1" checked> Not Slider</label><br>
                                            <label><input type="radio" id="status_disable" name="status" value="3"> Slider</label>
                                        </c:when>
                                        <c:when test="${p.getProduct_status() eq 3}">
                                            <label><input type="radio" id="status_enable" name="status" value="1"> Not Slider</label><br>
                                            <label><input type="radio" id="status_disable" name="status" value="3" checked> Slider</label>
                                        </c:when>
                                    </c:choose>
