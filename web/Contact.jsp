...
<body style="background:url(image/login.jpg); background-size: cover; "  >
    <div id="wrapper">
        ...
        <form action="Contact" method="Post" id="form-login">
            ...
            <div class="form-group">
                <i class="far fa-user"></i>
                <input type="email" class="form-input" name="email" value="${email}" placeholder="Email" required>
            </div>

            <div class="form-group">
                <i class="far fa-user"></i>
                <input type="tel" class="form-input" name="phone" value="${phone}" placeholder="Phone" pattern=".{8,20}" required>
            </div>
