...
public class BlogDao extends DBContext {
    ...
    public Blog getBlogByBlogId(int blogId) {
        Blog blog = null;
        String sql = "SELECT b.blog_id, b.blog_title, b.blog_image, u.user_name, b.`post_date`, b.Content\n"
                + "FROM `blog` b\n"
    ...
    public List<Blog> getBlogs() {
        ...
        String sql = "SELECT b.blog_id, b.blog_title, b.blog_image, u.user_name, b.post_date, b.content\n"
                + " FROM `blog` b JOIN `Users` u ON b.`user_id` = u.`user_id` order by b.`post_date` desc;";
        try {
            PreparedStatement ps = connection.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
