...
public class GetOrderDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        htmlBuilder.append("<p><strong>Status:</strong> ").append(order.getStatus()).append("</p>");
        ...
        completeHtmlBuilder.append("<div class=\"bill-section\">")
                ...
                .append("<div class=\"bill-section\">")
                .append("<div class=\"bill-info\">")
                .append("<p><strong>Total Amount:</strong> <span id=\"total-amount\">").append(String.format("%.3f", totalAmount)).append("</span> VND</p>")
                .append("</div>")
                .append("</div>");
