...
public class ProductLists extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String settingId = request.getParameter("settingId") == null ? "" : request.getParameter("settingId");
            String search = request.getParameter("search") == null ? "" : request.getParameter("search");
            String sort = request.getParameter("sort") == null ? "" : request.getParameter("sort");
            search = search.trim();
            ProductDAO pdao = new ProductDAO();
            ArrayList<Setting> clist = pdao.getCategory();
            int totalproduct = pdao.getNumberProduct(settingId, search);
            ...
            ArrayList<Product> plist = pdao.getAllProduct(settingId, search, index, sort);
